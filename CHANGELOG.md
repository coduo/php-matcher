...
- [#511](https://github.com/coduo/php-matcher/pull/511) - **allows Symfony 8.0 components** - [@smoench](https://github.com/smoench)

### Changed
- [039be3](https://github.com/coduo/php-matcher/commit/039be3db7fe6f4e6a558499e1e53b5c509e3591a) - **task: added nix-shell to php-matcher** - [@norberttech](https://github.com/norberttech)
- [#511](https://github.com/coduo/php-matcher/pull/511) - **dropped support for PHP < 8.3** - [@smoench](https://github.com/smoench)
...
### Updated
- [04d86a](https://github.com/coduo/php-matcher/commit/04d86aee40820044a4dd955a3037831e4fd84f46) - **README.md** - [@norberttech](https://github.com/norberttech)
